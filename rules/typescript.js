  ...
  overrides: [
    {
      ...
      rules: {
        ...
        '@typescript-eslint/comma-spacing':
          stylisticIssuesRules['comma-spacing'],
        ...
        '@typescript-eslint/init-declarations':
          variablesRules['init-declarations'],
        ...
        '@typescript-eslint/no-extra-semi':
          possibleErrorsRules['no-extra-semi'],
        ...
        '@typescript-eslint/no-invalid-this':
          bestPracticesRules['no-invalid-this'],
        ...
        '@typescript-eslint/return-await':
          bestPracticesRules['no-return-await'],
